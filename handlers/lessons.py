...
THEMATIC_TOPICS = [
    "Инверсия после отрицательных наречий (Never, Rarely, Not only, No sooner)",
    "Инверсия для эмфазы (Only after, So beautiful, Little did he know)",
    "Расщеплённые предложения (It was... that..., What... is...)",
    "Эллипсис и замена (опущение слов, one/so/do)",
    "Смешанные условные предложения (Past → Present, Present → Past)",
    "Условные предложения без if (otherwise, provided, as long as, on condition)",
    "Modal Perfect (must have done, could have done, should have done) – углубление",
    "Пассив с модальными глаголами (must be done, could have been done)",
    "Future Perfect Continuous (will have been doing)",
    "Future in the Past (would do, was going to) – сложные случаи",
    "Герундий и инфинитив – сложные глаголы (remember, forget, regret, try, mean)",
    "Перфектный герундий и инфинитив (having done, to have done)",
    "Пассивный герундий и инфинитив (being done, to be done, having been done)",
    "Косвенная речь – сложные случаи (смешение времён, разные глаголы)",
    "Глаголы передачи речи (advise, warn, accuse, boast, deny, admit, suggest)",
    "Косвенные вопросы – продвинутые (сложные конструкции)",
    "Пассив с глаголами передачи информации (It is said that..., He is said to be...)",
    "Пассив с предлогами (He was laughed at, This bed was slept in)",
    "Безличный пассив (It is believed that..., It was reported that...) – все времена",
    "Сокращённые определительные придаточные (the man sitting there, the book written by)",
    "Придаточные уступки (although, even though, albeit, despite, in spite of) – сложные нюансы",
    "Придаточные цели (to, in order to, so that, for fear that)",
    "Придаточные следствия (so...that, such...that) – углубление",
    "Выражение необходимости (need, needn't, didn't need to, needn't have done)",
    "Выражение критики и сожаления (should have done, could have done, might have done)",
    "Способность (can, could, be able to, manage to, succeed in)",
    "Конструкции сравнения as...as, not so...as, than, less...than",
    "Конструкция the more... the more (чем..., тем...)",
    "Конструкции too / enough (слишком / достаточно)",
    "Разговорные клише (That being said, Having said that, Come to think of it, Long story short)",
    "Дискурсивные маркеры (however, moreover, nevertheless, consequently, in contrast)",
    "Заполнители пауз и хезитации (well, you see, I mean, sort of, kind of)",
    "Словообразование (суффиксы, префиксы, сложные слова) – продвинутое",
    "Латинские и греческие корни (как догадываться о значении слов)",
    "Ложные друзья переводчика (продвинутые)",
    "Часто путаемые слова (affect/effect, principal/principle, imply/infer)",
    "Фразовые глаголы C1-C2 (часть 1)",
    "Фразовые глаголы C1-C2 (часть 2)",
    "Идиомы C1 (30 популярных идиом)",
    "Идиомы C2 (редкие и выразительные)",
    "Пунктуация в английском (запятые, точки с запятой, двоеточия, апострофы)",
    "Формальный и неформальный английский (регистры, стилистические различия)",
    "Hedging (смягчение утверждений: may, might, possibly, arguably)",
    "Риторические приёмы (триада, анафора, риторический вопрос, гипербола)"
]
