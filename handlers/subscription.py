...
PREMIUM_OFFER_TEXT = (
    ...
    "🎙️ Общение с AI — диалог как с живым человеком\n"
    "🎬 Ролевые игры — живая практика в реальных ситуациях\n"
    "🔀 Грамматика — все правила с практикой\n"
    "🥇 Лексика — слова и выражения по категориям\n"
    "🔉 Аудирование — тренировка восприятия на слух\n"
    "📝 Письмо — задания с детальной проверкой ИИ\n"
    "🗣️ Говорение — практика произношения с оценкой\n"
