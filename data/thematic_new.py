...
"""
        ...
        "faq": [
            {"question": "Сколько ложных друзей нужно знать для C1-C2?", "answer": "Около 100-200 самых частотных. Большинство из них вы увидите в тестах и реальном общении."}
        ]
    },
        "confusing_words": {
...
"""
        ...
        "faq": [
            {"question": "Можно ли использовать 'effect' как глагол?", "answer": "Да, но очень формально: to effect changes (осуществить изменения). Редко, но на C1-C2 знать стоит."}
        ]
    },
...
"""
        ...
        "faq": [
            {"question": "Можно ли использовать риторические вопросы в эссе IELTS?", "answer": "Лучше избегать. В академическом эссе вопросы не рекомендуются."}
        ]
    }
}