        ...
        "pages": [
            {
                ...
                "text": """
<b>🔤 Английский алфавит (26 букв)</b>
...
""",
    ...
    # Остальные уроки пока будут краткими (заглушками)
    # По мере готовности вы будете заменять их на полноценные версии.
    # Ниже приведены шаблоны для всех 36 уроков модулей A1.
    # Вы можете временно оставить их как есть, а потом переписать.
...
В английском <b>без глагола to be нельзя построить предложение</b> без действия. Поэтому его нужно выучить первым.
...
<blockquote>В русском языке слово «есть» опускается, а в английском – обязательно.</blockquote>
""",
                "image": None,
                "has_audio_buttons": False
            },
...
1. **Повесьте таблицу** с формами (I am, you are, he is…) на видное место и повторяйте каждый день.

2. **Используйте ритмичную фразу:**  
   <i>I am, you are, he is, she is, it is, we are, they are.</i>  
   Проговаривайте её как скороговорку.

3. **Составляйте короткие предложения про себя и вслух:**  
   • I am a student.  
   • You are a friend.  
   • He is a doctor.  
   • She is happy.  

4. **Обратите внимание на особую форму I am** – она не похожа на остальные, её нужно просто запомнить.

5. **Проверяйте себя:**  
   Закройте таблицу и скажите, какая форма подходит к местоимению:  
   He → is, We → are, I → am, They → are.
...
""",
        ...
        "faq": [
            {"question": "Почему I am, а не I is?", "answer": "Это историческая форма, сохранившаяся с древнеанглийского. Её нужно просто запомнить."},
            {"question": "Как перевести предложение без глагола на русский?", "answer": "На русский часто переводится без «есть» или с тире. Например: «She is a doctor» → «Она врач»."},
