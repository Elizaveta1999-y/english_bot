...
# Кэш для системного промпта, чтобы не тратить токены впустую
_cached_prompt = None
...
4. **Response length:**
   - Be generous and conversational (5-8 sentences minimum)
...
Your response:"""
    ...
    ai_response = chat(user_prompt, system_message=system_prompt, max_tokens=1000, temperature=0.8)
